...
public class PageTag extends SimpleTagSupport{
	...
	public void doTag() throws JspException,IOException{
		...
		if(pagingBean!=null){
			...
			{
				sb.append("<li class='disable'><a>首页</a></li>");
				sb.append("<li class='disables'><a href='#'>上一页</a></li>");
			}else{
				sb.append("<li><a href='").append(pagingBean.getPrefixUrl()).append("' aria-lable='Previous'><span aria-hidden = 'true'>首页</span></a></li>");
			...
			if(pagingBean.getCurrentPage()>=(pagingBean.getPageCount()-1))
			{
				...
				sb.append("<li><a href='").append(pagingBean.getPrefixUrl()).append(pagingBean.isAnd()?"&":"?").append("currentPage=").append(pagingBean.getPageCount()-1).append("' aria-lable='Previous'><span aria-hidden = 'true'>尾页</span></a></li>");
			}
			sb.append("<li><a href='#'>");
			sb.append("</span>");
