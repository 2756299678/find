...
<body onload="createCode()">
	...
	<div class="container">
				...
				<div class="modal fade" id="myModal1" tabindex="-1" role="dialog"
					...
					<div class="modal-dialog" role="document">
						<div class="modal-content">
							...
							<div class="modal-body">
								<form action="login?method=register" method="post" id="checkForm2">
									<div class="form-group">
										<label for="exampleInputPassword1">昵称</label> <input
											type="text" class="form-control" id="exampleInputPassword1"
											name="user" placeholder="username">
									...
									<div class="form-group">
										<label for="exampleInputPassword1">再次输入密码</label> <input
											type="password" class="form-control"
											id="exampleInputPassword2" name="password2" placeholder="repassword">
									</div>
									<div class="form-group">
				...
				<div class="container-fluid">
					...
					<div class="collapse navbar-collapse"
						...
						<ul class="nav navbar-nav">
							...
							<li><a href="select?method=lose">寻物</a></
							li>
							<li><a href="select?method=find">认领</a></li>
							<li><a href="#">查询</a></li>
						</ul>
		...
		<div class="row">
			<form action="select?method=lose" method="post">
				<div class="col-md-3 col-sm-6 col-xs-12">
					<div class="thumbnail">
						...
						<div class="caption">
							...
							<button type="submit" class="btn btn-danger btn-lg btn-block" name="type" value="书籍材料类">书籍材料类</button>
						</div>
					</div>
				</div>
				...
				<div class="col-md-3 col-sm-6 col-xs-12">
					<div class="thumbnail">
						...
						<div class="caption">
							...
							<button type="submit" class="btn btn-danger btn-lg btn-block" name="type" value="钥匙类">钥匙类</button>
						</div>
					</div>
				</div>
				...
				<div class="col-md-3 col-sm-6 col-xs-12">
					<div class="thumbnail">
						...
						<div class="caption">
							...
							<button type="submit" class="btn btn-danger btn-lg btn-block" name="type" value="U盘类">U盘类</button>
						</div>
					</div>
				</div>
				...
				<div class="col-md-3 col-sm-6 col-xs-12">
					<div class="thumbnail">
						...
						<div class="caption">
							...
							<button type="submit" class="btn btn-danger btn-lg btn-block" name="type" value="其他类">其他类</button>
						</div>
					</div>
				</div>
			</form>
		...
		<div class="row">
			<form action="select?method=find" method="post">
				<div class="col-md-3 col-sm-6 col-xs-12">
					<div class="thumbnail">
						<img src="img/book.jpg" alt="">
						<div class="caption">
